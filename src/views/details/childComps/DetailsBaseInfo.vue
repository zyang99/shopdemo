...
<!-- 当数据请求过来了再渲染 -->
  <div class="base-info" v-if="Object.keys(goodsInfo).length !== 0">
    ...
    <div class="info-price">
      ...
      <span class="o-price" v-show="goodsInfo.oldPrice">{{ goodsInfo.oldPrice }}</span>
      <span class="discount" v-show="goodsInfo.discount">{{ goodsInfo.discount }}</span>
    </div>
    ...
    <div class="info-service">
      <span class="info-service-item" v-for="index in goodsInfo.services" :key="index.index">
